document.addEventListener("DOMContentLoaded", () => {
  ...
  function showTask1() {
    taskContainer.innerHTML = `
        ...
        <div class="story-container">
          <img src="assets/page_2.png" loading="lazy" alt="page_2" class="page-image" />
  ...
  function showTask2() {
    taskContainer.innerHTML = `
        ...
        <div class="story-container">
          <img src="assets/page_3.png" loading="lazy" alt="page_3" class="page-image" />
          <div class="cards-stack">
            <div class="card">
  ...
  function showTask3() {
    taskContainer.innerHTML = `
        ...
        <div class="story-container">
          <img src="assets/page_4.png" loading="lazy" alt="page_4" class="page-image" />
          <div class="cards-stack">
            <div class="card">
  ...
  function showFinal() {
    ...
    taskContainer.innerHTML = `
        <h2>🎉 Сюрприз!!</h2>
        <div class="story-container">
          <img src="assets/page_5.png" loading="lazy" alt="page_5" class="page-image" />
          <div class="card" style="text-align: start;">
            ...
            <p>– Прости за всю эту детективную суету и кражу костюма, – смеется Питер, почесывая затылок. – Но мне надо было как-то отвлечь тебя. Надеюсь, загадки были не слишком сложными?</p>
